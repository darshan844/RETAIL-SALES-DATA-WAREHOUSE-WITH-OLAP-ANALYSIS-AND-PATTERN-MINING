-- schema_reset.sql
-- Drops existing DW tables (FK-safe order) then recreates them using the original schema.
-- Run as: cmd /c ""C:\Program Files\MySQL\MySQL Server 9.7\bin\mysql.exe" -u root -p < schema_reset.sql"
...
-- The schema below is copied from schema.sql
